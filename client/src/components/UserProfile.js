...
function UserProfile() {
    ...
    return (
        <div style={{marginTop: 'px'}}>  
            ...
            <div className="input-group yourFirstLast">
                <input type="text" aria-label="First name" id="firstName" placeholder="Your First name" name="firstName" ref={inputFirstName}  
                    onChange={handleInputChange} 
                    class="form-control" />
                <input type="text" aria-label="Last name" id="lastName" placeholder="Your Last name" name="lastName" ref={inputLastName}  
                    onChange={handleInputChange} 
                    class="form-control" />
            </div>
            ...
            <div className="input-group yourEmail">
                <input type="text" aria-label="Email" id="userEmail" placeholder=" What is your email?" name="userEmail" ref={inputEmail} 
                onChange={handleInputChange} 
                class="form-control" />
            </div>
            {/* <button type="button" class="btn btn-primary">Save</button> */}
            ...
            <div class="input-group yourAddress">
                <input type="text" aria-label="Address" id="userAddress" placeholder="What is your address?" name="userAddress" ref={inputAddress}  class="form-control" 
                onChange={handleInputChange} 
                />
            </div>
            {/* <button type="button" class="btn btn-primary">Save</button> */}
            ...
            <div class="input-group yourLocation">
                <input type="text" aria-label="Location" id="userLocation" placeholder="What is your closest major intersection" name="userLocation" ref={inputLocation}  class="form-control" 
                onChange={handleInputChange} 
                />
            </div>
            {/* <button type="button" class="btn btn-primary">Save</button> */}
            ...
            <div class="input-group input-group-lg yourNotes">
                <textarea class="form-control" aria-label="With textarea" id="userNotes" placeholder="Please add any notes we should know about you (ie: ...dietary restrictions? ...what you like to cook? ...what you like to eat? ...are you social? etc etc.)" name="userNotes" ref={inputNotes} 
                onChange={handleInputChange}
                />
            </div>
