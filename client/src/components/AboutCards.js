        ...
        <div>
            <section className="hero-section" target="_blank">
                <div className="card-grid">
                    ...
                    <a className="card" href="https://www.linkedin.com/in/doug-moore-dev/" target="_blank" rel="noopener noreferrer">
                    ...
                    <a className="card" href="https://www.linkedin.com/in/christinemclemens/" target="_blank" rel="noopener noreferrer">
                    ...
                    <a className="card" href="https://www.linkedin.com/in/saquib-ahmed-985933125/"  target="_blank" rel="noopener noreferrer">
